...
export default async function AnimeInfo({ params }: {
    ...
    return(
        <div className="text-[#A7ADBB] flex flex-col md:flex-row">
            ...
            <div className="w-fit md:w-2/3 ml-6 mt-2">
                ...
                <div>
                    <h1>Animeography</h1>
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 mt-4 mb-10 items-center">
                        {char.data.anime.length > 10 ? (
                            <>
                                ...
                                <Link href={`/anime/${params.id}/characters/${params.charId}/allAnime`} className="rounded-full h-fit text-6xl transition duration-150 ease-in-out active:translate-y-1 active:shadow-md shadow-black" title="Show More"><FaRegArrowAltCircleRight/></Link>
                            </>
                        ) : (
